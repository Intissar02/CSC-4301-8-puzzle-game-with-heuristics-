...
from search import breadthFirstSearch, depthFirstSearch, uniformCostSearch, aStarSearch, h3
...
def main():
    ...
    print("Generated Random 8-Puzzle:")
    print(puzzle)

    algorithms = {
        'A* with heuristic3': (aStarSearch, h3),
